...
class test_GoogleImageSearch(object):
    ...
    def test_extract_best_guess_tag(self):
        ...
        assert any('マミ' in tag for tag in actual) is True
    ...
    def test_extract_titles(self):
        ...
        assert any('マミ' in snippet for snippet in actual) is True
    ...
    def test_extract_all_image_urls(self):
        ...
        assert any('github.com' in url for url in actual) is True
